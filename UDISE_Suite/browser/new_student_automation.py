...
class UdiseNewStudentAutomation:
    def __init__(self, page: Any, logger: AppLogger):
        self.page = page
        self.logger = logger
        
    def scan_page_fields(self, student: NewStudent, progress_callback=None):
    ...
    def fill_visible_fields(self, student: NewStudent, progress_callback=None) -> list:
        """
